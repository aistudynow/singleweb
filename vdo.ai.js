/*18-Sep-2025 00:40:33*/
   ...
   var vdo_analyticsID = 'G-8J9SC9WB3T';
    ...
    vdo_analytics('event', 'loaded', { send_to: vdo_analyticsID, event_category: 'vdoaijs', event_label: 'v-aistudynow' });
  ...
  window.vdo_ai_ = window.vdo_ai_ ? window.vdo_ai_ : {};
    ...
    function customDimensions(arr) {
        try {
          ...
          logError(error, 'v-aistudynow');
        }
      }

function logPixel(requestObject){

    if(window.vdo_ai_.customDimensions && window.vdo_ai_.customDimensions['v-aistudynow']) {
        requestObject.dimensions = window.vdo_ai_.customDimensions['v-aistudynow'];
    }
...
function logError(e, tagname = 'v-aistudynow') {
if (typeof e === 'string') {
  e = {
    message: e,
    stack: e,
...
(function (window, document, deps, publisher) {
  ...
  var adframeConfig = {"desktop":{"show":true,"muted":true,"width":640,"height":360,"bottomMargin":10,"topMargin":10,"unitType":"content-floating","leftOrRight":{"position":"right","margin":10},"cancelTimeoutType":{"type":"timeout","eventtype":"readyforpreroll","cancelTimeout":60000},"passback":{"allow":false,"src":null,"string":"","timeout":15000,"type":"timeout","value":15000},"smallWidth":300,"smallHeight":169,"crossSize":17,"dispose_off":false,"bannerOff":false,"companionOff":false,"float_only_on_ads":false,"top_floating":false,"taboola_overlap_exception":false,"amzn_nlb_banner":true,"autoResize":false},"mobile":{"dispose_off":false,"show":true,"muted":true,"width":344,"height":258,"bottomMargin":10,"topMargin":0,"unitType":"content-floating","leftOrRight":{"position":"topDock","margin":10},"cancelTimeoutType":{"type":"timeout","eventtype":"readyforpreroll","cancelTimeout":60000},"passback":{"allow":false,"type":"timeout","value":15000,"src":null,"string":"","timeout":15000},"smallWidth":256,"smallHeight":192,"crossSize":24,"bannerOff":false,"companionOff":false,"float_only_on_ads":false,"top_floating":false,"taboola_overlap_exception":false,"amzn_nlb_banner":true,"mobile_floater_background":"#ffffff","autoResize":false},"bottomMargin":10,"cancelTimeout":10000,"id":"vdo_ai_9781","muted":true,"playsinline":true,"autoplay":true,"preload":true,"video_clickthrough_url":"","pubId":"5224","brandLogo":{"img":"","url":""},"coppa":false,"add_on_page_ready":"no","showLogo":true,"freqCap":"none","adbreak_offsets":[0,5,10,15,20,25],"show_on_ad":false,"autoReplay":true,"close_after_first_ad_timer":0,"canAutoplayCheck":true,"unfilled_auction_timer":"default","audiojk":100,"dual_player":false,"amzn_dual_player":false,"btfc":false,"dynamic_thumbnail":true,"cfvt":false,"unmute_on_interaction":true,"showOnlyOnAd":false,"disposeOnSkip":false,"autoplay_player":false,"float_after_cross_click":true,"playAdsOnly":false,"unitStyle":"single","dfp_companion":true,"vast_copy":true,"amplify_banner_tag":"","amplify_display_time":0,"playlist_url":"","playlistType":"local","ga_event":true,"use_global_hls":false,"vast_ad_gap":0,"domain":"aistudynow.com","path":"a.vdo.ai\/core\/v-aistudynow\/adframe.js","unitId":"_vdo_ads_player_ai_33351","tag_type":"other","parent_div":"v-aistudynow","tag_exclusion":{"exclude_mcm":false,"exclude_mcm_apac":false},"tag":"v-aistudynow","timestamp":1758181233,"b_domain":false,"agent":false,"playlist_id":null,"realParentDiv":"v-aistudynow","static_vpmute":true,"svpm_excluded_partners":null,"allowed_dims":0,"dependency":"dependencies_hbv4_latest","pubId_vdo":"5224","pubId_atlas":"5224","pubId_wc":"5224","pubId_jj":"","pubId_adsolut":"","pubId_hs":"","showOnlyFirst":false,"media_url":"https:\/\/h5.vdo.ai\/media_file\/v-aistudynow\/source\/","content_sources":[{"video":"uploads\/videos\/16563142467362b959861af0f","img":"uploads\/thumbnails\/16563142467362b959861af0f.png","duration":3021,"title":"What%20are%20the%20benefits%20of%203D%20printing%20for%20businesses","keyword":""},{"video":"uploads\/videos\/16558750687062b2a5fce03d7","img":"uploads\/thumbnails\/16558750687062b2a5fce03d7.png","duration":3026,"title":"How%20does%20overpopulation%20affect%20the%20future%3F","keyword":""},{"video":"uploads\/videos\/16576098417162cd1e71406fe","img":"uploads\/thumbnails\/16576098417162cd1e71406fe.png","duration":3005,"title":"AI%E2%80%99s%20impact%20on%20surveillance%20world","keyword":""},{"video":"uploads\/videos\/16580793842062d448988acb2","img":"uploads\/thumbnails\/16580793842062d448988acb2.png","duration":3003,"title":"Internet%20of%20things","keyword":""}],"show_on":"ads-ad-started","tagType":"video","google_mcm":"23206845375","google_mcm_apac":"23206845375","bidders":[],"targeting":[],"ibv_linked_tag":"","adx":[],"s2s":false,"overflow_size":false,"handle_url_change":true,"style":"","ver":"v6.0.0","vast":{"0":[{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/26001828,23206845375\/vdoai-dfp-parent-adunit\/z1_dfp_v_aistudynow_v_pre_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm","floor":null,"position":100},{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/22100121508,23206845375\/DFP_APAC_Parent_First_AdBreak\/ellipsis_dfp_v_aistudynow_v_pre_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm_apac","floor":null,"position":99}],"5":[{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/26001828,23206845375\/DFP_Z1_Parent_Second_AdBreak\/z1_dfp_v_aistudynow_v_mid1_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm","floor":null,"position":100},{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/22100121508,23206845375\/DFP_APAC_Parent_Second_AdBreak\/ellipsis_dfp_v_aistudynow_v_mid1_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm_apac","floor":null,"position":99}],"10":[{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/26001828,23206845375\/DFP_Z1_Parent_third_AdBreak\/z1_dfp_v_aistudynow_v_mid2_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm","floor":null,"position":100},{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/22100121508,23206845375\/DFP_APAC_Parent_third_AdBreak\/ellipsis_dfp_v_aistudynow_v_mid2_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm_apac","floor":null,"position":99}],"15":[{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/26001828,23206845375\/DFP_Z1_Parent_Fourth_AdBreak\/z1_dfp_v_aistudynow_v_mid3_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm","floor":null,"position":100},{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/22100121508,23206845375\/DFP_APAC_Parent_Fourth_AdBreak\/ellipsis_dfp_v_aistudynow_v_mid3_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm_apac","floor":null,"position":99}],"20":[{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/26001828,23206845375\/DFP_Z1_Parent_Fifth_AdBreak\/z1_dfp_v_aistudynow_v_mid4_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm","floor":null,"position":100},{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/22100121508,23206845375\/DFP_APAC_Parent_Fifth_AdBreak\/ellipsis_dfp_v_aistudynow_v_mid4_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm_apac","floor":null,"position":99}],"25":[{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/26001828,23206845375\/DFP_Z1_Parent_Sixth_AdBreak\/z1_dfp_v_aistudynow_v_mid5_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm","floor":null,"position":100},{"ad_url":"pubads.g.doubleclick.net\/gampad\/ads?iu=\/22100121508,23206845375\/DFP_APAC_Parent_Sixth_AdBreak\/ellipsis_dfp_v_aistudynow_v_mid5_1&description_url=http%3A%2F%2Faistudynow.com&tfcd=0&npa=0&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=&vpos=preroll&sz=288x162%7C300x250%7C400x300%7C419x236%7C640x360%7C640x480%7C1x1","partner":"google_mcm_apac","floor":null,"position":99}]},"companionBanner":{"google_mcm":{"placement":"\/26001828,23206845375\/Z1_Companion_Banner\/z1_dfp_v_aistudynow_companion_b_pre_1","upr":""},"gtr":{"include":["RO","GB","CA","DE","US","AE","AU"]},"rgtr":[{"geos":["RO","GB","CA","DE","US","AE","AU"],"time":30}]},"nonLinearBanner":{"google_mcm":{"placement":"\/26001828,23206845375\/Z1_Non_Linear_Banner\/z1_dfp_v_aistudynow_non_linear_b_pre_1","upr":""},"gtr":{"include":["BE","BG","BR","RO","JP","GB","HU","PT","PL","ZA","SA","ES","FR","FI","NL","NO","NZ","CH","CA","SK","KR","SE","DK","DE","US","AE","IS","AU","AT","IE"]}}};
  ...
  function startTag(version){
    ...
    loadPlayerDiv('_vdo_ads_player_ai_33351','v-aistudynow',iframe_Burst);
    changeParentDivId();
    loadGptCompanion('v-aistudynow');
  ...
  function changeParentDivId(){
    ...
    function onConfigLoaded(response) {
        ...
        if (response.agent == "false") {
            ...
            feedReq.open(
                "get",
                "//a.vdo.ai/core/v-aistudynow/dynamic_feed?playlist_id=" +
                custom_placement_id,
                true
            );
            feedReq.send();
    ...
    event_label: "v-aistudynow",
        ...
        var ALLOWED_URL = `https://targeting.vdo.ai/allowed_url.php?test=cache&type=json&mul_type=os+wb&tag=v-aistudynow&domain=${adframeConfig.domain}&c=${country}&ua=${navigator.userAgent}&cb=${CB}`;
...
Promise.all([
    ...
    loadConfig(),
        ...
        logError(msg, 'v-aistudynow');
    });
  //#endregion
})(w_vdo, d_vdo, '//a.vdo.ai/core/', 'v-aistudynow');
